...
//  <o> 串口1 DMA发送中断抢占优先级
#define USART1_DMA_TX_IT_PREEMPT 3
//  <o> 串口1 DMA发送中断子优先级
#define USART1_DMA_TX_IT_SUB     2
...
//  <o> 接收fifo大小(必须为2的幂次方)
#define USART1_RX_FIFO_SZIE      128
...
//  <o> 串口1 DMA接收中断抢占优先级
#define USART1_DMA_RX_IT_PREEMPT 3
//  <o> 串口1 DMA接收中断子优先级
#define USART1_DMA_RX_IT_SUB     1
...
//  <o USART2_HWCONTROL> 硬件流控
//      <UART_HWCONTROL_NONE=>无
//      <UART_HWCONTROL_RTS=>RTS
//      <UART_HWCONTROL_CTS=>CTS
//      <UART_HWCONTROL_RTS_CTS=>RTS+CTS
#define USART2_HWCONTROL UART_HWCONTROL_NONE
...
//  <o> 接收fifo大小(必须为2的幂次方)
#define USART2_RX_FIFO_SZIE      512
